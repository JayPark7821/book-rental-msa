...
class RentalCard private constructor(
    ...
    companion object {
        ...
        fun createItemRentedEvent(idName: IdName, item: Item, point: Long) = ItemRented(idName, item, point)

        fun createItemReturnedEvent(idName: IdName, item: Item, point: Long) = ItemReturned(idName, item, point)

        fun createOverdueClearedEvent(idName: IdName, point: Long) = OverdueCleared(idName, point)
